...
export const metadata: Metadata = {
  ...
  description: `Complete your booking for the 30-minute consultation that maps your personalised PCOS diagnosis and recovery plan. ${publicEnv.assessmentFeeDisplay}, fully refundable.`,
