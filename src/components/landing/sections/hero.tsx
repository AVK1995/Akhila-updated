      ...
      */}
      <div className="container-tight relative flex flex-1 flex-col items-center justify-center gap-5 sm:block sm:flex-none sm:items-stretch sm:gap-0 sm:text-center">
        ...
        <motion.button
          ...
          /* Caption stays on ONE line from 360px up (every current phone). Below
             that (old 320px iPhone SE/5) nowrap would clip the text inside the
             pill, so allow it to wrap there instead. */
